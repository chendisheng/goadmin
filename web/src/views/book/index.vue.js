...
__VLS_86.slots.default;
{
    ...
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    (__VLS_ctx.formatEnumLabel(row.category, __VLS_ctx.categoryEnumLabelMap));
}
var __VLS_86;
...
__VLS_94.slots.default;
{
    ...
    const [{ row }] = __VLS_getSlotParams(__VLS_thisSlot);
    (__VLS_ctx.formatEnumLabel(row.status, __VLS_ctx.statusEnumLabelMap));
}
var __VLS_94;
...
const __VLS_148 = __VLS_asFunctionalComponent(AdminFormDialog, new AdminFormDialog({
    ...
    title: (__VLS_ctx.editingId ? '编辑Book' : '新增Book'),
...
const __VLS_280 = __VLS_asFunctionalComponent(__VLS_279, new __VLS_279({
    ...
    placeholder: ('请输入Cover Image Url'),
}));
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            query: query,
            form: form,
            categoryEnumLabelMap: categoryEnumLabelMap,
            statusEnumLabelMap: statusEnumLabelMap,
