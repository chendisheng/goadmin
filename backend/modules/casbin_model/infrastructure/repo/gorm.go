...
func NewGormRepository(db *gorm.DB) (*GormRepository, error) {
	if db == nil {
		return nil, fmt.Errorf("casbin_model gorm repository requires db")
	}
...
func Migrate(db *gorm.DB) error {
	if db == nil {
		return fmt.Errorf("casbin_model migrate requires db")
	}
...
func (r *GormRepository) List(ctx context.Context, keyword string, page int, pageSize int) ([]model.CasbinModel, int64, error) {
	if r == nil || r.db == nil {
		return nil, 0, fmt.Errorf("casbin_model gorm repository is not configured")
	}
...
func (r *GormRepository) Get(ctx context.Context, name string) (*model.CasbinModel, error) {
	if r == nil || r.db == nil {
		return nil, fmt.Errorf("casbin_model gorm repository is not configured")
	}
...
func (r *GormRepository) Create(ctx context.Context, item *model.CasbinModel) (*model.CasbinModel, error) {
	...
	if item == nil {
		return nil, fmt.Errorf("casbin_model item is nil")
	}
...
func (r *GormRepository) Delete(ctx context.Context, name string) error {
	if r == nil || r.db == nil {
		return fmt.Errorf("casbin_model gorm repository is not configured")
	}
