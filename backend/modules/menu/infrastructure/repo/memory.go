...
func defaultMenus() []model.Menu {
	return []model.Menu{
		...
		{ID: "menu-casbin", ParentID: "menu-system", Name: "Casbin", Path: "/system/casbin", Component: "Layout", Icon: "menu", Sort: 7, Permission: "system:view", Type: model.TypeDirectory, Visible: true, Enabled: true, Redirect: "/system/casbin/models"},
		{ID: "menu-casbin-models", ParentID: "menu-casbin", Name: "Models", Path: "/system/casbin/models", Component: "view/casbin_model/index", Icon: "menu", Sort: 1, Permission: "casbin_model:list", Type: model.TypeMenu, Visible: true, Enabled: true},
		{ID: "menu-casbin-rules", ParentID: "menu-casbin", Name: "Rules", Path: "/system/casbin/rules", Component: "view/casbin_rule/index", Icon: "menu", Sort: 2, Permission: "casbin_rule:list", Type: model.TypeMenu, Visible: true, Enabled: true},
