...
func TestModuleOwnershipAndPlanRoundTrip(t *testing.T) {
	ownership := ModuleOwnership{
		...
		ManifestPath:     "backend/modules/inventory/codegen.manifest.json",
		ManifestFormat:   "json",
		Source:           "dsl",
		OwnedFiles: []DeleteItem{{
			Module:  "inventory",
			Kind:    AssetKindSourceFile,
			Path:    "backend/modules/inventory/module.go",
		...
		Compatibility: LegacyCompatibilityRule{
			...
			ManifestPaths:          []string{"backend/modules/inventory/codegen.manifest.json"},
			ModuleRoots:            []string{"backend/modules/inventory"},
			OwnedFilePatterns:      []string{"backend/modules/inventory/**"},
	...
	plan := DeletePlan{
		...
		SourceFiles:     []DeleteItem{{Module: "inventory", Kind: AssetKindSourceFile, Path: "backend/modules/inventory/module.go", Origin: AssetOriginGenerated, Managed: true}},
	...
	result := DeleteResult{
		...
		Deleted:    []DeleteItem{{Module: "inventory", Kind: AssetKindSourceFile, Path: "backend/modules/inventory/module.go", Origin: AssetOriginGenerated, Managed: true}},
