...
func defaultRules() []casbinadapter.Rule {
	return []casbinadapter.Rule{
		...
		{Subject: "admin", Object: "/system/casbin", Action: "GET"},
		{Subject: "admin", Object: "/system/casbin/overview", Action: "GET"},
		{Subject: "admin", Object: "/system/casbin/models", Action: "GET"},
		{Subject: "admin", Object: "/system/casbin/rules", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/dictionaries/categories", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/dictionaries/categories/:id", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/dictionaries/categories", Action: "POST"},
		{Subject: "admin", Object: "/api/v1/dictionaries/categories/:id", Action: "PUT"},
		{Subject: "admin", Object: "/api/v1/dictionaries/categories/:id", Action: "DELETE"},
		{Subject: "admin", Object: "/api/v1/dictionaries/items", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/dictionaries/items/:id", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/dictionaries/items", Action: "POST"},
		{Subject: "admin", Object: "/api/v1/dictionaries/items/:id", Action: "PUT"},
		...
		{Subject: "admin", Object: "/api/v1/uploads/files/storage/default", Action: "GET"},
		{Subject: "admin", Object: "/api/v1/uploads/files/storage/default", Action: "PUT"},
