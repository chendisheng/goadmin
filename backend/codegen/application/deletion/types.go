...
type PreviewReport struct {
	Request    deletionmodel.DeleteRequest `json:"request,omitempty"`
	Resolution ModuleResolution            `json:"resolution,omitempty"`
	Plan       deletionmodel.DeletePlan    `json:"plan,omitempty"`
}
...
type ModuleResolution struct {
	...
	PolicyStore         deletionmodel.PolicyStoreKind         `json:"policy_store,omitempty"`
	Compatibility       deletionmodel.LegacyCompatibilityRule `json:"compatibility,omitempty"`
}
...
func normalizePolicyStoreSource(value string) deletionmodel.PolicyStoreKind {
