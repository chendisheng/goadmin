...
func defaultMenus() []model.Menu {
	return []model.Menu{
		...
		{ID: "menu-plugins", ParentID: "menu-system", Name: "Plugins", Path: "/system/plugins", Component: "view/plugin/center/index", Icon: "box", Sort: 4, Permission: "plugin:list", Type: model.TypeMenu, Visible: true, Enabled: true},
		{ID: "menu-codegen", ParentID: "menu-system", Name: "CodeGen", Path: "/system/codegen", Component: "view/system/codegen/index", Icon: "magic-stick", Sort: 5, Permission: "codegen:view", Type: model.TypeMenu, Visible: true, Enabled: true},
