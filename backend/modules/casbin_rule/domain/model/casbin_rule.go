...
type CasbinRule struct {
	...
	Ptype     string    `json:"ptype,omitempty" gorm:"column:ptype;type:varchar(255);size:255"`
	V0        string    `json:"v0,omitempty" gorm:"column:v0;type:varchar(255);size:255"`
	V1        string    `json:"v1,omitempty" gorm:"column:v1;type:varchar(255);size:255"`
	V2        string    `json:"v2,omitempty" gorm:"column:v2;type:varchar(255);size:255"`
