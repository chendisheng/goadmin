...
> - `backend/core/auth/casbin/adapter/policy.csv` 作为 Casbin policy 的源头，DB 模式必须自动跟随 `csv` 变化
...
`apply` 不是新的生成器，而是 `backend/codegen/application/apply` 中的编排层：
...
└──────────────────────────────────────────────────────────────┘
                              ↓
┌──────────────────────────────────────────────────────────────┐
│                        应用编排层 / backend/codegen/application/apply                       │
│  - 统一解析输入                                                │
│  - 生成计划                                                    │
│  - 编排生成、安装、同步、验证                                  │
└──────────────────────────────────────────────────────────────┘
...
│ backend / web / docs │   │ menus / routes / meta │   │ policy_rule / reload │
└──────────────────────┘   └──────────────────────┘   └──────────────────────┘
```
